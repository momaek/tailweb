    ...
    <NotificationGroup group="success">
      ...
      >
        <div class="w-full max-w-sm">
          ...
          >
            <div
              class="flex w-full max-w-sm mx-auto mt-4 overflow-hidden bg-white dark:bg-background-emphasis rounded-lg shadow-md"
              v-for="notification in notifications"
              :key="notification.id"
            >
              <div class="flex items-center justify-center w-12 bg-green-500 dark:bg-green-800">
        ...
        <div class="w-full max-w-sm">
          ...
          >
            <div
              ...
              :key="notification.id"
            >
              <div class="flex items-center justify-center w-12 bg-red-500 dark:bg-red-800">
                <svg class="w-6 h-6 text-white fill-current" viewBox="0 0 40 40">
                  <path
